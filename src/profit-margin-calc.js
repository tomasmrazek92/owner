...
document.addEventListener('DOMContentLoaded', () => {
    ...
    calcBtn.addEventListener('click', (e) => {
        ...
        // get inputs
        let totalRevenue = parseFloat(document.querySelector('#total-revenue').value.replaceAll(',', '')) || 0;
        let cogs = parseFloat(document.querySelector('#cogs').value.replaceAll(',', '')) || 0;
        let operatingCosts = parseFloat(document.querySelector('#operating-costs').value.replaceAll(',', '')) || 0;
    ...
    resetBtn.addEventListener('click', (e) => {
        ...
        document.querySelector('#profit-margin-calculator').scrollIntoView({ behavior: "smooth", block: 'start' });
    });
